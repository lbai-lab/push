...
from nns.schnet.base_util import (compute_neighbors, conditional_grad, get_pbc_distances, radius_graph_pbc,)
...
class BaseModel(nn.Module):
    ...
    def generate_graph(
        ...
        if use_pbc:
            ...
            if otf_graph:
                edge_index = radius_graph(data.pos, r=cutoff, batch=data.batch, max_num_neighbors=max_neighbors,)
