...
python train.py --model unet -t ensemble_push -n 1 -d 1 -e 10 -dl 2000 -cp || true
python train.py --model unet -t mswag_push -n 1 -d 1 --pretrain_epochs 3 --swag_epochs 10 -dl 2000 -cp || true
python train.py --model unet -t svgd_push -n 1 -d 1 -e 10 -dl 2000 -cp -mef || true
